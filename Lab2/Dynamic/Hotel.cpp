...
void Hotel::hotelToFile(){
	std::ofstream out;
	out.open("/home/ivan/lab2/Dynamic/Result.txt");
	if(out.is_open()){
		cout << "Information about hotel: " << endl;
		out << "Hotel number: " << this->hotelNumber << endl;
		out << "Hotel name: " << this->hotelName << endl;
		out << "Country: " << this->country << endl;
		out << "City: " << this->city << endl;
		out << "Address: " << this->address << endl;
		out << "Amount of stars: " << this->amountOfStars << endl;
		out << "Contact person: " << this->contactPerson << endl;
		out << endl;
	}
	out.close();
}
